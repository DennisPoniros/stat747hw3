...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{output/svr_residuals.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{output/partial_dependence.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{output/svm_misclassified.png}
